 ...
 *   Last Modified : Jul 22, 2013 18:34:21 JST
 * @author Shinsuke OTA <ota@cns.s.u-tokyo.ac.jp>
 *  
 *  
 *    Copyright (C)2013
 */
#include "TModuleDecoderV1740.h"
#include <TRawDataFadc.h>

art::TModuleDecoderV1740::TModuleDecoderV1740()
...
Int_t art::TModuleDecoderV1740::Decode(char* buf, const int &size, TObjArray *seg)
{
