...
#ifndef TStreamingModuleDecoderHRTDC_Unpaired_H
#define TStreamingModuleDecoderHRTDC_Unpaired_H

#include "TStreamingModuleDecoderImpl.h"
namespace art {
namespace streaming {
namespace v1 {
class TStreamingModuleDecoderHRTDC_Unpaired;
}
}  // namespace streaming
}  // namespace art
...
class art::streaming::v1::TStreamingModuleDecoderHRTDC_Unpaired
    : public TStreamingModuleDecoderImpl<TStreamingModuleDecoderHRTDC_Unpaired> {
  public:
   TStreamingModuleDecoderHRTDC_Unpaired();
   virtual ~TStreamingModuleDecoderHRTDC_Unpaired();
   ...
   inline static std::string fgName{"art::streaming::v1::TStreamingModuleDecoderHRTDC_Unpaired"};
   static int fgID;
   static const int kID = {7};
   static const int fgNCh = {64};
   ...
   static const unsigned int kHeaderTDCL = 0x0b;   // (b001011) tdc data
...
#endif  // TStreamingModuleDecoderHRTDC_Unpaired_H
