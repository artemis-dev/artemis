//
// File generated by rootcint at Fri Jul 13 12:22:24 2012
...
namespace ROOT {
   void TCatCmdHstore_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void *new_TCatCmdHstore(void *p = 0);
   static void *newArray_TCatCmdHstore(Long_t size, void *p);
   static void delete_TCatCmdHstore(void *p);
   static void deleteArray_TCatCmdHstore(void *p);
   static void destruct_TCatCmdHstore(void *p);
   static void streamer_TCatCmdHstore(TBuffer &buf, void *obj);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TCatCmdHstore*)
   {
      ::TCatCmdHstore *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::TCatCmdHstore >(0);
      static ::ROOT::TGenericClassInfo 
         instance("TCatCmdHstore", ::TCatCmdHstore::Class_Version(), "./TCatCmdHstore.h", 19,
                  typeid(::TCatCmdHstore), DefineBehavior(ptr, ptr),
                  &::TCatCmdHstore::Dictionary, isa_proxy, 0,
                  sizeof(::TCatCmdHstore) );
      instance.SetNew(&new_TCatCmdHstore);
      instance.SetNewArray(&newArray_TCatCmdHstore);
      instance.SetDelete(&delete_TCatCmdHstore);
      instance.SetDeleteArray(&deleteArray_TCatCmdHstore);
      instance.SetDestructor(&destruct_TCatCmdHstore);
      instance.SetStreamerFunc(&streamer_TCatCmdHstore);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TCatCmdHstore*)
   {
      return GenerateInitInstanceLocal((::TCatCmdHstore*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::TCatCmdHstore*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
TClass *TCatCmdHstore::fgIsA = 0;  // static to hold class pointer

//______________________________________________________________________________
const char *TCatCmdHstore::Class_Name()
{
   return "TCatCmdHstore";
}

//______________________________________________________________________________
const char *TCatCmdHstore::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TCatCmdHstore*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TCatCmdHstore::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TCatCmdHstore*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void TCatCmdHstore::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TCatCmdHstore*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *TCatCmdHstore::Class()
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TCatCmdHstore*)0x0)->GetClass();
   return fgIsA;
}
...
//______________________________________________________________________________
void TCatCmdHstore::Streamer(TBuffer &R__b)
{
   // Stream an object of class TCatCmdHstore.

   UInt_t R__s, R__c;
   if (R__b.IsReading()) {
      Version_t R__v = R__b.ReadVersion(&R__s, &R__c); if (R__v) { }
      R__b.CheckByteCount(R__s, R__c, TCatCmdHstore::IsA());
   } else {
      R__c = R__b.WriteVersion(TCatCmdHstore::IsA(), kTRUE);
      R__b.SetByteCount(R__c, kTRUE);
   }
}

//______________________________________________________________________________
void TCatCmdHstore::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class TCatCmdHstore.
      TClass *R__cl = ::TCatCmdHstore::IsA();
      if (R__cl || R__insp.IsA()) { }
      R__insp.GenericShowMembers("TCatCmd", ( ::TCatCmd *) (this ), false);
}
...
namespace ROOT {
   ...
   static void *new_TCatCmdHstore(void *p) {
      return  p ? new(p) ::TCatCmdHstore : new ::TCatCmdHstore;
   }
   static void *newArray_TCatCmdHstore(Long_t nElements, void *p) {
      return p ? new(p) ::TCatCmdHstore[nElements] : new ::TCatCmdHstore[nElements];
   }
   // Wrapper around operator delete
   static void delete_TCatCmdHstore(void *p) {
      delete ((::TCatCmdHstore*)p);
   }
   static void deleteArray_TCatCmdHstore(void *p) {
      delete [] ((::TCatCmdHstore*)p);
   }
   static void destruct_TCatCmdHstore(void *p) {
      typedef ::TCatCmdHstore current_t;
      ((current_t*)p)->~current_t();
   }
   // Wrapper around a custom streamer member function.
   static void streamer_TCatCmdHstore(TBuffer &buf, void *obj) {
      ((::TCatCmdHstore*)obj)->::TCatCmdHstore::Streamer(buf);
   }
} // end of namespace ROOT for class ::TCatCmdHstore
...
void TCatCmdFactory::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fFlagExactName", &fFlagExactName);
...
extern "C" void G__set_cpp_environmentcatcmd_dict() {
  ...
  G__add_compiledheader("TCatCmdHstore.h");
...
{
      ((TCatCmdFactory*) G__getstructoffset())->SetOptExactName((Bool_t) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__catcmd_dict_182_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic assignment operator
static int G__catcmd_dict_182_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* TCatCmdHstore */
static int G__catcmd_dict_207_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TCatCmdHstore* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
   if (n) {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new TCatCmdHstore[n];
     } else {
       p = new((void*) gvp) TCatCmdHstore[n];
     }
   } else {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new TCatCmdHstore;
     } else {
       p = new((void*) gvp) TCatCmdHstore;
     }
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
      G__letint(result7, 108, (long) ((TCatCmdHstore*) G__getstructoffset())->Run((const char*) G__int(libp->para[0]), (Option_t*) G__int(libp->para[1])));
      break;
   case 1:
      G__letint(result7, 108, (long) ((TCatCmdHstore*) G__getstructoffset())->Run((const char*) G__int(libp->para[0])));
      break;
   }
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) TCatCmdHstore::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TCatCmdHstore::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TCatCmdHstore::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      TCatCmdHstore::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((TCatCmdHstore*) G__getstructoffset())->StreamerNVirtual(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TCatCmdHstore::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TCatCmdHstore::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TCatCmdHstore::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__catcmd_dict_207_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TCatCmdHstore::DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__catcmd_dict_207_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)

{
   TCatCmdHstore* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new TCatCmdHstore(*(TCatCmdHstore*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef TCatCmdHstore G__TTCatCmdHstore;
static int G__catcmd_dict_207_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (TCatCmdHstore*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((TCatCmdHstore*) (soff+(sizeof(TCatCmdHstore)*i)))->~G__TTCatCmdHstore();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((TCatCmdHstore*) (soff))->~G__TTCatCmdHstore();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
// automatic assignment operator
static int G__catcmd_dict_207_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TCatCmdHstore* dest = (TCatCmdHstore*) G__getstructoffset();
   *dest = *(TCatCmdHstore*) libp->para[0].ref;
   const TCatCmdHstore& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
extern "C" void G__cpp_setup_inheritancecatcmd_dict() {
   ...
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore))) {
     TCatCmdHstore *G__Lderived;
     G__Lderived=(TCatCmdHstore*)0x1000;
     {
       TCatCmd *G__Lpbase=(TCatCmd*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore),G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmd),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
     {
       TNamed *G__Lpbase=(TNamed*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore),G__get_linked_tagnum(&G__catcmd_dictLN_TNamed),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
     {
       TObject *G__Lpbase=(TObject*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore),G__get_linked_tagnum(&G__catcmd_dictLN_TObject),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
   }
}
...
static void G__setup_memvarTCatCmdFactory(void) {
   ...
   G__memvar_setup((void*)0,103,0,0,-1,G__defined_typename("Bool_t"),-1,4,"fFlagExactName=",0,(char*)NULL);
...
static void G__setup_memvarTCatCmdCd(void) {
   ...
   /* TCatCmdHstore */
static void G__setup_memvarTCatCmdHstore(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore));
   { TCatCmdHstore *p; p=(TCatCmdHstore*)0x1000; if (p) { }
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__catcmd_dictLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncTCatCmdFactory(void) {
   ...
   G__memfunc_setup("SetOptExactName",1493,G__catcmd_dict_182_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "g - 'Bool_t' 0 - flag", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Class",502,G__catcmd_dict_182_0_7, 85, G__get_linked_tagnum(&G__catcmd_dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TCatCmdFactory::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__catcmd_dict_182_0_8, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCatCmdFactory::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__catcmd_dict_182_0_9, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TCatCmdFactory::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__catcmd_dict_182_0_10, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TCatCmdFactory::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__catcmd_dict_182_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__catcmd_dict_182_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCatCmdFactory::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__catcmd_dict_182_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TCatCmdFactory::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__catcmd_dict_182_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCatCmdFactory::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__catcmd_dict_182_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TCatCmdFactory::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TCatCmdFactory", 1368, G__catcmd_dict_182_0_19, (int) ('i'), G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdFactory), -1, 0, 1, 1, 1, 0, "u 'TCatCmdFactory' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TCatCmdFactory", 1494, G__catcmd_dict_182_0_20, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__catcmd_dict_182_0_21, (int) ('u'), G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdFactory), -1, 1, 1, 1, 1, 0, "u 'TCatCmdFactory' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncTCatCmdHstore(void) {
   /* TCatCmdHstore */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore));
   G__memfunc_setup("TCatCmdHstore",1269,G__catcmd_dict_207_0_1, 105, G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Cmd",276,(G__InterfaceMethod) NULL,108, -1, G__defined_typename("Long_t"), 0, 1, 1, 1, 0, "u 'vector<TString,allocator<TString> >' 'vector<TString>' 0 - args", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Run",309,G__catcmd_dict_207_0_3, 108, -1, G__defined_typename("Long_t"), 0, 2, 1, 1, 0, 
"C - - 10 - filename C - 'Option_t' 10 '\"\"' -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("WriteRecursive",1475,(G__InterfaceMethod) NULL, 121, -1, -1, 0, 2, 1, 2, 0, 
"U 'TDirectory' - 0 - parent U 'TList' - 0 - list", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Class",502,G__catcmd_dict_207_0_5, 85, G__get_linked_tagnum(&G__catcmd_dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TCatCmdHstore::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__catcmd_dict_207_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCatCmdHstore::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__catcmd_dict_207_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TCatCmdHstore::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__catcmd_dict_207_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TCatCmdHstore::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__catcmd_dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - insp", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__catcmd_dict_207_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__catcmd_dict_207_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCatCmdHstore::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__catcmd_dict_207_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TCatCmdHstore::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__catcmd_dict_207_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TCatCmdHstore::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__catcmd_dict_207_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TCatCmdHstore::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TCatCmdHstore", 1269, G__catcmd_dict_207_0_17, (int) ('i'), G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore), -1, 0, 1, 1, 1, 0, "u 'TCatCmdHstore' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TCatCmdHstore", 1395, G__catcmd_dict_207_0_18, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__catcmd_dict_207_0_19, (int) ('u'), G__get_linked_tagnum(&G__catcmd_dictLN_TCatCmdHstore), -1, 1, 1, 1, 1, 0, "u 'TCatCmdHstore' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__catcmd_dictLN_TDirectory = { "TDirectory" , 99 , -1 };
...
G__linked_taginfo G__catcmd_dictLN_TList = { "TList" , 99 , -1 };
...
G__linked_taginfo G__catcmd_dictLN_TCatCmdHstore = { "TCatCmdHstore" , 99 , -1 };

/* Reset class/struct taginfo */
extern "C" void G__cpp_reset_tagtablecatcmd_dict() {
  G__catcmd_dictLN_TClass.tagnum = -1 ;
  G__catcmd_dictLN_TBuffer.tagnum = -1 ;
  G__catcmd_dictLN_TDirectory.tagnum = -1 ;
  ...
  G__catcmd_dictLN_TList.tagnum = -1 ;
  ...
  G__catcmd_dictLN_TCatCmdHstore.tagnum = -1 ;
}
...
extern "C" void G__cpp_setup_tagtablecatcmd_dict() {
   ...
   G__get_linked_tagnum_fwd(&G__catcmd_dictLN_TDirectory);
   ...
   G__get_linked_tagnum_fwd(&G__catcmd_dictLN_TList);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__catcmd_dictLN_TCatCmdHstore),sizeof(TCatCmdHstore),-1,62720,(char*)NULL,G__setup_memvarTCatCmdHstore,G__setup_memfuncTCatCmdHstore);
}
