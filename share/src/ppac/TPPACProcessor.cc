...
using art::TPPACProcessor;

ClassImp(art::TPPACProcessor)

// Default constructor
TPPACProcessor::TPPACProcessor() 
   : fPPACOut(NULL), 
...
void TPPACProcessor::Init(TEventCollection *col) {
